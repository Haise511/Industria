interface Props { size?: number; color?: string; unread?: boolean }

export function BellIcon({ size = 20, color = 'currentColor', unread = false }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      {unread && <circle cx="16" cy="4" r="2" fill="#FF5356" />}
    </svg>
  )
}
